        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">{{trans('profile_trans.Candidat')}}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{trans('profile_trans.Dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{trans('profile_trans.Candidat')}}</li>
                        </ol>
                    </div>
                        ...
                        <div class="row">
                                ...
                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                    <div class="flex-shrink-0">
                                        <div class="avatar-xl me-3">
                                            <img src="../../{{$candidat->user->profile->picture}}" alt="" class="img-fluid rounded-circle d-block">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div>
                                            <h5 class="font-size-16 mb-1">{{$candidat->user->name}}</h5>
                                            <p class="text-muted font-size-13">{{$candidat->user->profile->poste}}</p>

                                            <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>{{$candidat->user->email}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-auto order-1 order-sm-2">
                                <div class="d-flex align-items-start justify-content-end gap-2">
                                    <div>
                                        <button type="button" class="btn btn-soft-light" data-bs-toggle="modal" data-bs-target="#exampleModalLg"><i class="me-1"></i> Modifier</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title h4" id="exampleModalLgLabel">{{trans('profile_trans.Update_Candidat')}}</h5>
                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        
                                        <form class="needs-validation" novalidate="" method="post" action="{{'profile'.$candidat->user->profile->id}}"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl">
                                                <div class="text-muted">
                                                    <p class="mb-2">{{$candidat->user->profile->bio}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="pt-3">
                                        ...
                                        <div class="text-muted">
                                            <p>{{$candidat->user->profile->experience}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
