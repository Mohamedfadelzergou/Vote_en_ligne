        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">{{trans('profile_trans.Profile')}}</h4>
                                ...
                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                    <div class="flex-shrink-0">
                                        <div class="avatar-xl me-3">
                                            <img src="{{auth()->user()->profile->picture}}" alt="" class="img-fluid rounded-circle d-block">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div>
                                            <h5 class="font-size-16 mb-1">{{auth()->user()->name}}</h5>
                                            <p class="text-muted font-size-13">{{auth()->user()->profile->poste}}</p>
                                ...
                                <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title h4" id="exampleModalLgLabel">{{trans('profile_trans.Update_Profile')}}</h5>
                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        
                                        <form class="needs-validation" novalidate="" method="post" action="{{'Prodil/'.auth()->user()->profile->id}}"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl">
                                                <div class="text-muted">
                                                    <p class="mb-2">{{auth()->user()->profile->bio}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="pt-3">
                                        ...
                                        <div class="text-muted">
                                            <p>{{auth()->user()->profile->experience}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
